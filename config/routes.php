        ...
        (new Route('loggjafarthing', '/loggjafarthing', ['handler' => Handler\Assemblies::class]))
            ->addRoute(
                (new Route('loggjafarthing.item', '/(?<assembly_id>\d+)', ['handler' => Handler\Assembly::class]))
                    ...
                    ->addRoute((new Route('loggjafarthing.item.parties', '/raedutimar', ['handler' => Handler\AssemblySpeechAggregation::class])))
                    ...
                    ->addRoute((new Route('loggjafarthing.item.government', '/thingmal/efnisflokkar', ['handler' => Handler\AssemblyContentCategories::class])))
                    ->addRoute((new Route('loggjafarthing.item.government', '/thingmal/stodur', ['handler' => Handler\AssemblyIssuesStatuses::class])))
                    ...
                    ->addRoute(
                        (new Route('loggjafarthing.item.issue.item', '/thingmal/(?<category>(a|b))/(?<issue_id>\d+)', ['handler' => Handler\AssemblyIssue::class]))
                            ...
                            ->addRoute(new Route('loggjafarthing.item.issue.item.speec', '/readur/samantekt', ['handler' => Handler\AssemblyIssueSpeechAggregation::class]))
                            ...
                            ->addRoute(new Route('loggjafarthing.item.issue.item.document', '/thingskjol', ['handler' => Handler\AssemblyIssueDocuments::class]))
                            ->addRoute(
                                (new Route('loggjafarthing.item.issue.item.document', '/thingskjol/(?<document_id>\d+)', ['handler' => Handler\AssemblyIssueDocument::class]))
                                    ->addRoute(new Route('loggjafarthing.item.issue.item.vote', '/atkaedagreidsla', ['handler' => Handler\AssemblyIssueDocumentsOutcome::class]))
                            )
                            ->addRoute(
